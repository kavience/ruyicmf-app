...
class MenuLogic
{
    ...
    public static function importMenus($app)
    {
        ...
        $newMenus = [];
        if ($app == 'admin') {
            $filePatten         = CMF_ROOT . "vendor/ruyicmf/cmf-app/src/{$app}/controller/*Controller.php";
            $coreAppControllers = cmf_scan_dir($filePatten);

            $filePatten          = CMF_ROOT . "vendor/ruyicmf/cmf-appstore/src/controller/*Controller.php";
            ...
            $filePatten         = CMF_ROOT . "vendor/ruyicmf/cmf-app/src/{$app}/controller/Admin*Controller.php";
            $coreAppControllers = cmf_scan_dir($filePatten);
